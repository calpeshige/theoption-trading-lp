...
const articles: Article[] = [
    ...
    },
    {
        ...
        items: [
            ...
            'この無償アップデート版は、実際にシステムを稼働させ、弊社が指定するプラットフォーム（YouTubeのコメント欄等）にて、「実際にシステムを稼働して感じたおすすめ機能」や「他の方にも推奨できる具体的なポイント」のフィードバック投稿にご協力いただける【アクティブユーザー様限定の追加特典】となります。',
            '本運用は、実運用に基づいたリアルな情報を共有することを目的としており、弊社から事実と異なる虚偽の評価を強制することは一切ございません。本特典の受け取り条件（フィードバックの投稿）にご同意いただけない場合は、ご購入時の初期バージョンのまま継続してご利用いただく形となります。',
        ],
    },
    {
        subject: '禁止事項および損害賠償',
